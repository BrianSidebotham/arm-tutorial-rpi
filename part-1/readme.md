...
which is targeting using `build-rpi-bplus.bat/sh` and finally the V2 board which features a quad core
processor and also has the extended IO connector and fixing holes which is targeted with
`build-rpi-2.bat/sh`.
...
$ ll
total 48
drwxr-xr-x 2 brian brian  4096 Jan  4 22:13 ./
drwxr-xr-x 6 brian brian  4096 Jan  4 21:33 ../
-rw-r--r-- 1 brian brian   109 Jan  4 21:33 armc-01.c
-rw-r--r-- 1 brian brian   136 Jan  4 21:33 build.bat
-rw-r--r-- 1 brian brian   147 Jan  4 21:33 build-rpi-2.bat
-rw-r--r-- 1 brian brian   147 Jan  4 21:33 build-rpi-2.sh
-rw-r--r-- 1 brian brian   147 Jan  4 21:33 build-rpi-bplus.bat
-rw-r--r-- 1 brian brian   147 Jan  4 21:33 build-rpi-bplus.sh
-rwxr-xr-x 1 brian brian   524 Jan  4 22:18 build.sh*
-rwxr-xr-x 1 brian brian 37628 Jan  4 22:13 kernel.elf*
brian@brian-PH67-UD3-B3 ~/valvers-new/arm-tutorial-rpi/part-1/armc-01 $
```
...
${ARMCC} ${CCOPTS} armc-01.c -o kernel.elf
```
